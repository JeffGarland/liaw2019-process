...
namespace std {
  ...
  public:
    ...
    // Construct a child from a property list 
    template<process_initializer... Inits>
    explicit process(const filesystem::path& exe, std::initializer_list<std::string_view> args, Inits&&... inits);

    // Construct a child from a property list 
    template<process_initializer... Inits>
    explicit process(const filesystem::path& exe, std::initializer_list<std::wstring_view> args, Inits&&... inits);
