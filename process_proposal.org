...
#+Title: D1750R1 A Proposal to Add Process Management to the C++ Standard Library
...
~process(const std::filesystem::path&, const argument-list&, Inits&&... init)~
...
namespace std {
  ...
  concept argument-list =
    requires convertible_to<ranges::iter_value_t<R>, string> ||
    requires convertible_to<ranges::iter_value_t<R>, wstring> ||
    requires convertible_to<ranges::iter_value_t<R>, u8string>;
  ...
  template<class T, argument-list Args>
  concept process_launcher = requires(T launcher, const Args& a) {
    requires convertible_to<ranges::iter_value_t<Args>, string>;
...
namespace std {
  ...
  public:
    ...
    template<argument-list R, process_initializer... Inits>
...
namespace std {
  ...
  public:
    ...
    template<argument-list Args, process_initializer... Inits>
...
namespace std {
  ...
  public:
    ...
    ranges::safe_iterator_t<Rng> path(OutputIt it) const;
    ...
    ranges::safe_iterator_t<Rng> extensions(It it) const;
  ...
  public:
    ...
    template<ranges::input_range Rng>
      requires convertible_to<ranges::iter_value_t<Rng>, value_type>
    entry(const Rng& r);
