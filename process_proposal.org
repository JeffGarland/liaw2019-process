...
Since limit also closes the standard handles unless they are explicitly redirected, passing in ~process_io{}~ would avoid them being closed when using ~limit_fd~.
