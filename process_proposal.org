...
~process(const std::filesystem::path&, const std::ranges::InputRange&, Inits&&... init)~
...
namespace std {
  ...
  template<class T, ranges::InputRange Args>
  concept process_launcher = requires(T launcher, const Args& a) {
    requires ConvertibleTo<ranges::iter_value_t<Args>, string>;
...
namespace std {
  ...
  public:
    ...
    template<ranges::InputRange R, process_initializer... Inits>
      requires ConvertibleTo<ranges::iter_value_t<Args>, string>
...
namespace std {
  ...
  public:
    ...
    template<ranges::InputRange<string> Args, process_initializer... Inits>
