...
namespace std {
  ...
  public:
    ...
    // KM: Additionally, a path should be possible to open a file just for the child process
...
** Classes ~basic_pipe_read_end~, ~basic_pipe_write_end~, ~basic_pipe~ Synopses
...
** Class templates ~basic_pipebuf~, ~basic_opstream~, ~basic_ipstream~ and ~basic_pstream~ Synopses
...
** Classes ~async_pipe_read_end~, ~async_pipe_write_end~, ~async_pipe~ Synopses
