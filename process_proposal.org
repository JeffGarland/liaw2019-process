...
~process(const std::filesystem::path&, const std::ranges::input_range&, Inits&&... init)~
...
namespace std {
  ...
  template<class T, ranges::input_range Args>
...
namespace std {
  ...
  public:
    ...
    template<ranges::input_range R, process_initializer... Inits>
      requires convertible_to<ranges::iter_value_t<Args>, string>
...
namespace std {
  ...
  public:
    ...
    template<ranges::input_range Args, process_initializer... Inits>
      requires convertible_to<ranges::iter_value_t<Args>, string>
